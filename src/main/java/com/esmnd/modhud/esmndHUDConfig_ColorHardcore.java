...
public class esmndHUDConfig_ColorHardcore extends Screen {
    ...
    protected void init() {
        ...
        healthBarColorBoxGradientTwo = createColorField(leftCol, yStart, "Health Bar Gradient Two",
                String.format("%06X", config.getHardcoreGradientTwo() & 0xFFFFFF));

        healthBarColorBoxGradientOne = createColorField(leftCol, yStart + ySpacing, "Health Bar Gradient One",
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        renderColorPreview(poseStack, healthBarColorBoxGradientTwo);
        renderColorPreview(poseStack, healthBarColorBoxGradientOne);
        ...
        if (Minecraft.getInstance().options.forceUnicodeFont().get() == Boolean.TRUE) {
            ...
            drawString(poseStack, this.font, Component.translatable("esmndnewhud.screen.gradienttwo").getString(), healthBarColorBoxGradientOne.getX() - 115, healthBarColorBoxGradientOne.getY() + 6, 0xFFFFFF);
            drawString(poseStack, this.font, Component.translatable("esmndnewhud.screen.gradientone").getString(), healthBarColorBoxGradientTwo.getX() - 115, healthBarColorBoxGradientTwo.getY() + 6, 0xFFFFFF);
        }
        else if (Minecraft.getInstance().options.forceUnicodeFont().get() == Boolean.FALSE)
        {
            ...
            drawString(poseStack, this.font, Component.translatable("esmndnewhud.screen.gradienttwo").getString(), healthBarColorBoxGradientOne.getX() - 165, healthBarColorBoxGradientOne.getY() + 6, 0xFFFFFF);
            drawString(poseStack, this.font, Component.translatable("esmndnewhud.screen.gradientone").getString(), healthBarColorBoxGradientTwo.getX() - 165, healthBarColorBoxGradientTwo.getY() + 6, 0xFFFFFF);
        }
    }
        ...
        try {
            ...
            if (minecraft.player != null) {
                minecraft.player.displayClientMessage(
                        Component.literal("§aHUD Gradient colors saved successfully!"), false);
            }
        } catch (NumberFormatException e) {
            if (minecraft.player != null) {
                minecraft.player.displayClientMessage(
                        Component.literal("§cError Gradient color: Invalid color format!"), true);
            }
        }
    }
