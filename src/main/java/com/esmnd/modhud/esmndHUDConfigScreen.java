...
public class esmndHUDConfigScreen extends Screen {
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (gradientModeButton.isMouseOver(mouseX, mouseY))
            renderTooltip(poseStack, Component.translatable("esmndnewhud.button.gradienttooltip"), mouseX, mouseY);

        if (pulseModeButton.isMouseOver(mouseX, mouseY))
            renderTooltip(poseStack, Component.translatable("esmndnewhud.button.pulsetooltip"), mouseX, mouseY);

        if (fixedHUDSize.isMouseOver(mouseX, mouseY))
            renderTooltip(poseStack, Component.translatable("esmndnewhud.checkbox.size_dependency_tooltip"), mouseX, mouseY);

        if (hudScaleSlider.isMouseOver(mouseX, mouseY))
            renderTooltip(poseStack, Component.translatable("esmndnewhud.slider.size_dependency_tooltip"), mouseX, mouseY);
